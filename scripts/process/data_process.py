...
def parse_args():
    ...
    parser.add_argument("--data_dir", type=str,
                        default=os.path.join(os.environ.get("NORMA_RAW_DIR", "data/raw"), "mimiciv", "3.1"),
                        help="Directory to raw EHR data (MIMIC-IV is credentialed; NORMA_RAW_DIR)")
    parser.add_argument('--save_prefix', type=str,
                        default=os.path.join(os.environ.get("NORMA_DATA_DIR", "data/processed"), "mimiciv"),
                        help='Prefix of all saved files (NORMA_DATA_DIR)')
